      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        >
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="rounded bg-stone-900 border border-black px-10 py-2 font-[family-name:var(--font-barlow)] font-semibold uppercase text-white transition-all duration-300 hover:bg-white hover:text-black"
            >
              Wyślij
            </button>
          </div>
