...
export default function Footer() {
  return (
    <motion.footer
      ...
      className="w-full bg-stone-950 pb-12 text-white"
    >
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-center">
        <h1 className="mb-8 -translate-y-6 rounded-xl bg-stone-950 px-12 pt-7 font-[family-name:var(--font-storm)] text-4xl md:text-6xl">
